...
class Fifou {
  constructor(name, linkedBike) {
    ...
    this.blueMatrix = [
      ...
      0, 5, 5, 5, 5, 5, 5, 5, 8, 8, 8, 8, 8, 5, 5, 5, 5, 5, 5, 0,

      0, 5, 10, 10, 10, 10, 10, 12, 15, 15, 15, 15, 12, 10, 10, 10, 10, 10, 5,
      0,

      0, 5, 10, 15, 15, 15, 18, 20, 22, 22, 22, 22, 20, 18, 15, 15, 15, 10, 5,
      0,

      0, 5, 10, 15, 20, 22, 25, 28, 30, 30, 30, 30, 28, 25, 22, 20, 15, 10, 5,
      0,

      0, 5, 10, 15, 22, 25, 30, 33, 35, 35, 35, 35, 33, 30, 25, 22, 15, 10, 5,
      0,

      0, 5, 10, 18, 25, 30, 35, 38, 40, 40, 40, 40, 38, 35, 30, 25, 18, 10, 5,
      0,

      0, 5, 12, 20, 28, 33, 38, 42, 45, 45, 45, 45, 42, 38, 33, 28, 20, 12, 5,
      0,

      0, 8, 15, 22, 30, 35, 40, 45, 48, 50, 50, 48, 45, 40, 35, 30, 22, 15, 8,
      0,
...
bot1 = new Fifou("Fifou", player1);
bot2 = new Enzo("Enzo", player2);
